...
class HospitalDetailFragment : Fragment(), DatePickerDialog.OnDateSetListener {
        ...
        binding.apply {
            ...
            topAppBar.setOnMenuItemClickListener {
                when (it.itemId) {
                    R.id.userProfile -> {
                        val action =
                            HospitalDetailFragmentDirections.actionHospitalDetailFragmentToUserFragment()
    ...
    override fun onDateSet(view: DatePicker?, year: Int, month: Int, dayOfMonth: Int) {
        ...
        val appointment =
            AppointmentItem(args.name!!, args.address!!, getCurrentUserID(), sDate, choice)
        ...
        mFireStore.collection("Appointments")
            ...
            .addOnSuccessListener {
                ...
                Toast.makeText(context, "Randevu oluşturulmada hata alındı", Toast.LENGTH_SHORT)
                    .show()
            }
    }
